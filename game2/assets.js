...
(function (global) {
    ...
    function createWolf() {
        ...
        const GREY    = 0x7A7A7A;   // main fur
        const GREY_D  = 0x4A4A4A;   // darker markings (back, mask)
        const GREY_L  = 0xB0B0A8;   // lighter belly / muzzle
        const EYE     = 0xFFCC00;   // amber eyes
        const NOSE    = 0x111111;
